                  ...
                  <div key={plan.key} className="plan-card" style={{
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.45rem", marginBottom: "1.5rem" }}>
                      {[
                        ...
                        { show: plan.features.calendar, text: "30-Day Content Calendar (5 credits)" },
                        { show: plan.features.contentPack, text: "Content Pack (3 credits)" },
                        { show: plan.features.imageAI, text: "Image AI (2 credit)" },
