...
const CREATOR_PLANS = [
  ...
  },
  {
    ...
    price: "₹399", priceNum: 399, priceUSD: 9,
    wasPrice: "₹499", wasUSD: 12,
    period: "/month", badge: "🔥 Popular", color: "#22c55e",
    credits: 150, type: "creator",
    features: [
      "Everything in Free",
...
const AGENCY_PLANS = [
  {
    key: "agency",
    name: "Agency",
    price: "₹5,999", priceNum: 5999, priceUSD: 99,
    wasPrice: "₹7,499", wasUSD: 119,
    period: "/month", badge: "👑 All Access", color: "#f59e0b",
    credits: 2400, type: "agency",
    features: [
      "All 18 Creator + Advertiser Tools",
      "2,400 credits — unlimited workflow",
          ...
          <div style={{ maxWidth:680, margin:"0 auto" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:".55rem" }}>
              {[
                ...
                ["Creator vs Advertiser vs Agency?", "Creator plans are for social content — Instagram, YouTube, TikTok. Advertiser adds tools for running Google and Meta ad campaigns. Agency includes everything with 2,400 credits for managing multiple clients."],
